...
class TrainUI():
    def __init__(self,UIManager):
        ...
        self.panelArrow=velocimeterArrow.Arrow(("Images","arrow.png"),1,((pg.display.get_window_size()[0]/2)-40,30),(81,81))
        self.drag=False
    ...
    def render(self,screen):
        ...
        screen.blit(self.panelArrow.image,((pg.display.get_window_size()[0]/2)-55,15))
        if self.drag==True:
