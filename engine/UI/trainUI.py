import pygame as pg
from engine.UI import Button, image, velocimeterArrow
...
class TrainUI():
    def __init__(self,UIManager):
        ...
        self.speedPanel=image.Image(("Images","speedPanel.png"),1,((pg.display.get_window_size()[0]/2)-40,30),(81,81))
        self.panelArrow=velocimeterArrow.Arrow(("Images","arrow.png"),1,((pg.display.get_window_size()[0]/2),70),(81,81))
        self.drag=False
    ...
    def render(self,screen):
        ...
        screen.blit(self.speedPanel.image,((pg.display.get_window_size()[0]/2)-40,30))
        screen.blit(self.panelArrow.image,self.panelArrow.rect)
        print(self.panelArrow.rect)
        if self.drag==True:
    ...
    def reOrganizeAll(self):
        ...
        self.limiterPanel.setCoords((pg.display.get_window_size()[0]-70,30))
        self.speedLimiter.setCoords((pg.display.get_window_size()[0]-95,self.speedLimiter.rect.y))
        self.panelArrow.setCoords(((pg.display.get_window_size()[0]/2),70))